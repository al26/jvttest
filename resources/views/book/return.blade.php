                ...
                <div class="card-body">
                    <form method="post" action="{{route('book.doreturn', ['book' => encrypt($book->id)])}}">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="title" name="title" placeholder="Judul Buku" value="{{$book->book->title}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="author" class="col-sm-2 col-form-label">Pengarang</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="author" name="author" placeholder="Pengarang" value="{{$book->book->author}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="isbn" class="col-sm-2 col-form-label">ISBN</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="isbn" name="isbn" placeholder="isbn" value="{{$book->book->isbn}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="published" class="col-sm-2 col-form-label">Tahun Publikasi</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="published" name="published" placeholder="Tahun Publikasi" value="{{$book->book->published}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Tahun Publikasi" value="{{$book->member->fullname}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="date_out" class="col-sm-2 col-form-label">Tanggal Pinjam</label>
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="date_out" name="date_out" placeholder="Tanggal Pinjam" value="{{$book->date_out}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="date_in" class="col-sm-2 col-form-label">Tanggal Kembali</label>
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="date_in" name="date_in" placeholder="Tanggal Kembali" value="{{$book->date_in}}">
                        </div>
                      </div>
                      <div class="form-group row">
